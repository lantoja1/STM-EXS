...
public class TimeWindowArrayAdapter extends ArrayAdapter<TimeWindow> {

    Activity context;
    List<TimeWindow> timeWindows;
    private SparseBooleanArray mSelectedItemsIds;

    public TimeWindowArrayAdapter(Activity context, int resId, List<TimeWindow> timeWindows) {
